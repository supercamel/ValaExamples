...
public class Application : Gtk.Window {
    private void show_about_dialog() {
        ...
        about_dialog.comments = "This is a simple Gtk application.";
        about_dialog.license_type = License.MIT_X11;
        about_dialog.website = "https://www.example.com";
        about_dialog.website_label = "Visit our website";
        about_dialog.wrap_license = true;

        // Retrieve and print whether the license text is wrapped
        bool is_license_wrapped = about_dialog.get_wrap_license();
        stdout.printf("License Text Wrapped: %b\n", is_license_wrapped);
